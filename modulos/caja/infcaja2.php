...
$sql4= "SELECT [Workstation]
      ...
      --,CONVERT(varchar,[DocDate],103) Fecha
      --,[WhsCode]
  ...
  WHERE CONVERT(varchar,[DocDate],103) LIKE '06/10/2015'
  AND WhsCode LIKE 'ZFI.1132'
              ...
              <thead>
				...
				?>             
                             <tr >
									  ...
									  <td ><strong><?php echo number_format($TotalIngreso, 0, ',', '.'); ?></strong></td>
                             </tr>             
                                    ...
                                    <tr >
                                      ...
                                      <td colspan="2" >&nbsp;</td>
                                      <td colspan="2" id="celdcolor" >TOTAL INGRESO</td>
                                      <td id="celdcolor2" ><strong><?php echo number_format(($TOTALBOLETA+$TOTALFACT)-$acumstd3, 0, '', '.'); ?></strong></td>
                                    </tr>
