...
$(document).ready(function() {
     $("#descargarExcel").click(function(){
		...
		var workstation = '<?php if($_SESSION['workstation'] == '8') {echo '3';} else {echo $_SESSION['workstation'];}?>';
		doc.text(45, 20, workstation);
		
		doc.text(20, 30, "MODULO:");
		var bodega = '<?php 
		if($_SESSION['bodega'] == '000'){
			echo '2077';
		}else if($_SESSION['bodega'] == '001'){
			echo '1010';
		}else if($_SESSION['bodega'] == '002'){
			echo '1132';
		}else if($_SESSION['bodega'] == '003'){
			echo '181';
		}else if($_SESSION['bodega'] == '004'){
			echo '184';
		}else if($_SESSION['bodega'] == '005'){
			echo '2002';
		}else if($_SESSION['bodega'] == '006'){
			echo '6115';
		}else if($_SESSION['bodega'] == '007'){
			echo '6130';
		}else if($_SESSION['bodega'] == '008'){
			echo '2077';
		}
		?>';
        ...
        <div id="one"> <form action="" method="GET" id="horizontalForm">
            ...
            <fieldset>
				<legend>Ingresar fecha</legend>
					<input name="opc" type="hidden" id="opc" size="40" class="required" value="reporteCaja" />
			...
			<thead>
              ...
              <thead>
              	<tr>
					<th colspan="9" align="left" style="border: 1px solid black;">CAJA: <?php echo $_SESSION['workstation'];?></th>
				 ...
				 if($_SESSION['bodega'] == '000'){
					$sql="
						...
						WHERE 
							...
							T1.Bodega = '".$_SESSION['bodega']."' AND 
							T1.Workstation = '".$_SESSION['workstation']."' AND
							T1.TipoDocto <> '99'
						) as Tabla
...
//echo $sql;
	...
	$sql2 = "
		...
		(
			SELECT 
				(SELECT TOP 1 NumeroDocto FROM RP_VICENCIO.dbo.RP_ReceiptsCab_SAP WHERE TipoDocto = '1' AND FechaDocto > DATEADD(day,-1,'".$fecha." 00:00:00') AND FechaDocto < DATEADD(day,-1,'".$fecha." 23:59:59') AND Bodega = '".$_SESSION['bodega']."' AND Workstation = '".$_SESSION['workstation']."' ORDER BY NumeroDocto DESC) as Tipo1,
				(SELECT TOP 1 NumeroDocto FROM RP_VICENCIO.dbo.RP_ReceiptsCab_SAP WHERE TipoDocto = '2' AND FechaDocto > DATEADD(day,-1,'".$fecha." 00:00:00') AND FechaDocto < DATEADD(day,-1,'".$fecha." 23:59:59') AND Bodega = '".$_SESSION['bodega']."' AND Workstation = '".$_SESSION['workstation']."' ORDER BY NumeroDocto DESC) as Tipo2,
				(SELECT TOP 1 NumeroDocto FROM RP_VICENCIO.dbo.RP_ReceiptsCab_SAP WHERE TipoDocto = '3' AND FechaDocto > DATEADD(day,-1,'".$fecha." 00:00:00') AND FechaDocto < DATEADD(day,-1,'".$fecha." 23:59:59') AND Bodega = '".$_SESSION['bodega']."' AND Workstation = '".$_SESSION['workstation']."' ORDER BY NumeroDocto DESC) as Tipo3,
				(SELECT TOP 1 NumeroDocto FROM RP_VICENCIO.dbo.RP_ReceiptsCab_SAP WHERE TipoDocto = '4' AND FechaDocto > DATEADD(day,-1,'".$fecha." 00:00:00') AND FechaDocto < DATEADD(day,-1,'".$fecha." 23:59:59') AND Bodega = '".$_SESSION['bodega']."' AND Workstation = '".$_SESSION['workstation']."' ORDER BY NumeroDocto DESC) as Tipo4,
				(SELECT TOP 1 NumeroDocto FROM RP_VICENCIO.dbo.RP_ReceiptsCab_SAP WHERE TipoDocto = '99' AND FechaDocto > DATEADD(day,-1,'".$fecha." 00:00:00') AND FechaDocto < DATEADD(day,-1,'".$fecha." 23:59:59') AND Bodega = '".$_SESSION['bodega']."' AND Workstation = '".$_SESSION['workstation']."' ORDER BY NumeroDocto DESC) as Tipo99
