...
<table id="ssptable2" class="lista" style="display:none;">
  ...
  <tr>
    ...
    <td align="right" style="border-left: 2px solid #689DED; border-bottom: 2px solid #689DED; background-color:#DCE6F1;"><?php echo number_format((($SUBTOTAL_ZFI181[$anio-3]-$SUBTOTAL_ZFI181[$anio-4])/$SUBTOTAL_ZFI181[$anio-4])*100,0,',','.')."%"; ?></td>
    ...
    <td align="right" style="border-left: 2px solid #689DED; border-right: 2px solid #689DED; border-bottom: 2px solid #689DED; background-color:#DCE6F1;"><?php echo number_format((($SUBTOTAL_ZFI181[$anio]-$SUBTOTAL_ZFI181[$anio-1])/$SUBTOTAL_ZFI181[$anio-1])*100,0,',','.')."%"; ?></td>
    <td></td>
  ...
  <tr>
    ...
    <td align="right" style="border-top: 2px solid #689DED; border-left: 2px solid #689DED; border-bottom: 2px solid #689DED; background-color:#DCE6F1;"><?php echo number_format($SUBTOTAL_ZFI6130[$anio]+$TOTAL_ZFI6115[$anio],0,',','.'); ?></td>
    <td align="right" style="border-top: 2px solid #689DED; border-left: 2px solid #689DED; border-bottom: 2px solid #689DED; background-color:#DCE6F1;"><?php echo number_format($SUBTOTAL_LOCAL2[$anio-1],0,',','.'); ?></td>
    <td align="right" style="border-top: 2px solid #689DED; border-left: 2px solid #689DED; border-bottom: 2px solid #689DED; background-color:#DCE6F1;"><?php echo number_format($SUBTOTAL_LOCAL2[$anio],0,',','.'); ?></td>
    <td align="right" style="border-top: 2px solid #689DED; border-left: 2px solid #689DED; border-bottom: 2px solid #689DED; background-color:#DCE6F1;"><?php echo number_format($SUBTOTAL_LOCAL8[$anio-1],0,',','.'); ?></td>
    <td align="right" style="border-top: 2px solid #689DED; border-left: 2px solid #689DED; border-bottom: 2px solid #689DED; background-color:#DCE6F1;"><?php echo number_format($SUBTOTAL_LOCAL8[$anio],0,',','.'); ?></td>
    <td align="right" style="border-top: 2px solid #689DED; border-left: 2px solid #689DED; border-right: 2px solid #689DED; border-bottom: 2px solid #689DED; background-color:#DCE6F1;"><?php echo number_format($SUBTOTAL_LOCAL8[$anio]+$SUBTOTAL_LOCAL2[$anio],0,',','.'); ?></td>
  </tr>
  <tr>
    <td colspan="2">SUB CRECIMIENTO ANUAL</td>
    ...
    <td></td>
    <td></td>
    <td align="right" style="border-left: 2px solid #689DED;  border-right: 2px solid #689DED; border-bottom: 2px solid #689DED; background-color:#DCE6F1;"><?php echo number_format((($SUBTOTAL_LOCAL2[$anio]-$SUBTOTAL_LOCAL2[$anio-1])/$SUBTOTAL_LOCAL2[$anio-1])*100,0,',','.')."%"; ?></td>
    <td></td>
    <td align="right" style="border-left: 2px solid #689DED; border-right: 2px solid #689DED; border-bottom: 2px solid #689DED; background-color:#DCE6F1;"><?php echo number_format((($SUBTOTAL_LOCAL8[$anio]-$SUBTOTAL_LOCAL8[$anio-1])/$SUBTOTAL_LOCAL8[$anio-1])*100,0,',','.')."%"; ?></td>
    <td></td>
  </tr>
  ...
  <tr>
    ...
    <td></td>
    <td align="right" style="border-left: 2px solid #689DED; border-right: 2px solid #689DED; border-bottom: 2px solid #689DED; background-color:#DCE6F1;"><?php echo number_format((($TOTAL_LOCAL8[$anio]-$TOTAL_LOCAL8[$anio-1])/$TOTAL_LOCAL8[$anio-1])*100,0,',','.')."%"; ?></td>
    <td></td>
  </tr> 
</table>