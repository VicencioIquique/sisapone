        ...
        <div id="one"> <form action="" method="GET" id="horizontalForm">
            ...
            <fieldset>
				<legend>Filtros</legend>
							 ...
							 <input name="opc" type="hidden" id="opc" size="40" class="required" value="ventasPorVendedor" />
...
{
	$titulo = "Total_UNDS";
	$sumTotales = ",SUM(TABLA.TotalCLP)      [Total_CLP]
                   ,SUM(TABLA.TotalUSD)      [Total_USD]
	               ,SUM(TABLA.TotalCIF)      [CtoVtaCIF]";
	$pivotTotales = ",PV.TotalCLP
		            ,PV.TotalUSD
		            ,PV.TotalCIF";
    $pivote ="[Cantidad]";
}
...
overflow-y:hidden;">				
            <table   width="2500px;" id="tablelike"  class="lista">
              <thead>
				...
				<tr>
						<th>Informe de Ventas por Vendedor <?php echo $periodo;  ?> 
                        <?php
						if($proveedor)
		...
		<?php
					...
					while($resultado = odbc_fetch_array($rs))
					{
						...
						echo'
						<tr>
						<td >'.utf8_encode((string)$resultado["Vendedor"]).'</td>';
