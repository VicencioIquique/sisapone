					...
					$cantotal =0;
							...
							//  echo $resultado["estado"];
								...
								if($resultado["Estado"]>0)
								{
									...
									{
							   echo '<tr>
									<td style="background-color:#6C6B6B;color:#fff;font-weight:bold; font-size:15px; width:23px; text-align:center;" ><a style="color:#fff;"   href="index.php?opc=validarDSM&nDsm='.$resultado["NroDEM"].'">'.utf8_safe($resultado["NroDEM"]).'</a></td>';
									}
									echo '
								...
								{
							   echo '<tr>
									<td style="background-color:#5484C7;color:#fff;font-weight:bold; font-size:15px; width:23px; text-align:center;" ><a  style="color:#fff;" href="index.php?opc=validarDSM&nDsm='.$resultado["NroDEM"].'">'.utf8_safe($resultado["NroDEM"]).'</a></td>
									<td ><strong>'.$resultado["Fecha"].'</strong></td>
									<td >'.$resultado["TOrigen"].'</td>
									<td >'.getmodulo((int)$resultado["modulo"]).'</td>
									<td >'.$resultado["TotalItem"].'</td>' ;
