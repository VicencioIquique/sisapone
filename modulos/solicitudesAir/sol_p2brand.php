...
$(document).ready(function() {
	     $('.text').editable('modulos/solicitudesAir/save.php');
	
	fn_eliminar_articulolistaAir();	//eliminar de lista
	fn_revisar_solicitudAir();
...
<div class="paso" style="margin-bottom:10px;" ><a style="color:#FFF;" href="index.php?opc=nuevaSolicitudbrandAir">1 Paso</a></div><div  class="paso_selected"  style="margin-bottom:10px;" class="paso" >2 Paso</div><div style="margin-bottom:10px;" class="paso" >3 Paso</div>
    <form id="horizontalForm">
     <table  id="ssptable3" class="lista">
              <thead>
                    <tr>
                        <th>código</th>
                        <th>descripción</th>
...
";
            ...
            <?php 
				...
				<input type="button" value="Validar"  class="submit" style=" float:left; margin-top:0px;" onclick="javascript: fn_validar_solAir();" />';	
				}
