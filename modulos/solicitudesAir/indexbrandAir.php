				...
				else
				{
					...
					$cantotal =0;
						...
						if (odbc_next_result($rs))
						{
							  ...
							  {
							   echo '<tr>
									<td style="background-color:#146672;color:#fff;font-weight:bold; font-size:15px; width:23px; text-align:center;" ><a style="color:#fff;" href="index.php?opc=paso2brandAir&idsol='.$resultado["solicitud_id"].'">'.utf8_safe($resultado["solicitud_id"]).'</a></td>
							    ...
							    if($resultado["estado"]>1)
							  {
								  ...
								  {
							   echo '<tr>
									<td style="background-color:#705249;color:#fff;font-weight:bold; font-size:15px; width:23px; text-align:center;" ><a  style="color:#fff;" href="index.php?opc=paso2brandAir&idsol='.$resultado["solicitud_id"].'">'.utf8_safe($resultado["solicitud_id"]).'</a></td>';
								  }
