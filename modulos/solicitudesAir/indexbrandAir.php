		...
		$filaPag =25; 
				...
				else
				{
					...
					$sqlfilas="SELECT     COUNT(solicitud_id) AS Filas
								FROM [RP_REGGEN].[dbo].[SI_SolicitudesMercaderia_ON]
					...
					if($page < 1)
					{
				 	...
				 	$sql=" DECLARE @rowsperpage INT
							...
							WHERE A.rownum 
							BETWEEN (@start) AND (@start + @rowsperpage) ORDER BY estado, solicitud_id DESC ";
							//echo $sql;
					...
					$cantotal =0;
						...
						if (odbc_next_result($rs))
						{
							  ...
							  {
							   echo '<tr>
									<td style="background-color:#146672;color:#fff;font-weight:bold; font-size:15px; width:23px; text-align:center;" ><a style="color:#fff;" href="index.php?opc=paso2brandAir&idsol='.$resultado["solicitud_id"].'">'.utf8_encode($resultado["solicitud_id"]).'</a></td>
							    ...
							    if($resultado["estado"]>1)
							  {
								  ...
								  {
							   echo '<tr>
									<td style="background-color:#705249;color:#fff;font-weight:bold; font-size:15px; width:23px; text-align:center;" ><a  style="color:#fff;" href="index.php?opc=paso2brandAir&idsol='.$resultado["solicitud_id"].'">'.utf8_encode($resultado["solicitud_id"]).'</a></td>';
								  }
							   ...
							   echo '<tr>
							     ...
							     echo '<tr>
								    ...
								    {
										echo '<td ><a class="enviar_SAPAIR" id="'.$resultado["solicitud_id"].'" ><img src="images/saplogo.png" width="40px" height="20px" ></a></td>
    ...
    if($filas != 0)
    {
       ...
       ?><ul id="pagination-clean"><?php
         ...
         <?php
              ...
              {?>
                <li><a href="?opc=nuevaSolicitudbrandAir&page=<?php echo $i;?>"><?php echo $i;?></a></li>
        <?php }
           
           //Y SI LA ULTIMA PÁGINA ES MAYOR QUE LA ACTUAL MUESTRO EL BOTON NEXT O LO DESHABILITO
            if($lastpage >$page )
            {?>      
                <li class="next"><a href="?opc=nuevaSolicitudbrandAir&page=<?php echo $nextpage;?>" >Siguiente &raquo;</a></li><?php
            }
            else
            {?>
        ...
        ?>
            <li class="previous"><a href="?opc=nuevaSolicitudbrandAir&page=<?php echo $prevpage;?>">&laquo; Anterior</a></li><?php
            ...
            ?>       <li class="active"><?php echo $i;?></li><?php
                ...
                {
            ?>       <li><a href="?opc=nuevaSolicitudbrandAir&page=<?php echo $i;?>" ><?php echo $i;?></a></li><?php
                }
            }
