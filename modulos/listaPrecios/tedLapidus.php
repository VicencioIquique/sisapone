		 ...
		 <div id="dv">
			...
			<thead>
              ...
              <thead>
				<tr></tr>
              	<tr>
                	<th colspan="13" align="center" style="font-size:18px; border-top: 1px solid #676767; border-right: 1px solid #676767; border-left: 1px solid #676767; background-color:#b6b6b6;"><?php echo 'Lista de Precios Ted Lapidus- Área Comercial / Comité Ejecutivo';?></th>
                </tr>
              </thead>
              <thead>
              	<tr>
                	<th colspan="13" align="center" style="font-size:14px; border-right: 1px solid #676767; border-left: 1px solid #676767;background-color:#b6b6b6;"><?php echo 'Vigencia '.date("Y"); ?></th>
                </tr>
              </thead>
              <thead>
              	<tr>
                	<th colspan="13" align="center" style="font-size:12px; border-bottom:1px solid #676767; border-right: 1px solid #676767; border-left: 1px solid #676767;background-color:#b6b6b6;"><?php echo 'Marca : ' .$fmarca.' - Brand Manager: '.$vendedorSelect; ?></th>
                </tr>
              </thead>
			 <thead>
					<tr>
            ...
            <thead>
				<tr>
                    <th style="border-top: 1px solid #676767;">LINEA</th>
					<th style="border-top: 1px solid #676767;">REFERENCE</th>
					<th style="border-top: 1px solid #676767;">DESCRIPTION</th>
					<th style="border-top: 1px solid #676767;">SKU / EAN</th>
					<th style="border-top: 1px solid #676767;">Tamaño ml</th>
					<th style="border-top: 1px solid #676767;">Segmento</th>
					<th style="border-top: 1px solid #676767;">Género</th>
					<th style="border-top: 1px solid #676767;">Estatus</th>
					<th style="border-top: 1px solid #676767;">Unidades por caja</th>
					<th style="border-top: 1px solid #676767;">Precio Compra USD</th>
					<th style="border-top: 1px solid #676767;">Precio DFS USD</th>
					<th style="border-top: 1px solid #676767;">Precio Venta CLP Zofri</th>
					<th style="border-top: 1px solid #676767;">Precio Venta CLP Aero</th>
				</tr>
			</head>
                <tbody>
                 <?php
		...
		if($consultar){
			...
			while($resultado = odbc_fetch_array($rs)){
				...
				if($repiteLinea == utf8_safe($resultado['LINEA'])){
					echo '<td style="background-color:#ffff99;" ></td>';
					...
					echo '<td style="border-top: 1px solid #676767; text-align:center; font-weight:bold; font-size:16px; background-color:#ffff99;">'.utf8_safe($resultado['LINEA']).'</td>';
