		...
		if($consultar){
			...
			while($resultado = odbc_fetch_array($rs)){
				...
				if($repiteLinea == utf8_encode($resultado['LINEA'])){
					...
					echo '<td colspan="13" style="border: 1px solid; text-align:left; font-weight:bold; font-size:16px; background-color:#d9d9d9; color:#FFF;">'.utf8_encode($resultado['LINEA']).'</td>';
					echo '</tr>';
					echo '<tr>';
