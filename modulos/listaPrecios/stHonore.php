		 ...
		 <div id="dv">
			...
			<thead >
              ...
              <thead >
				<tr></tr>
              	<tr>
                	<th colspan="13" align="left" style="color:#FFF;font-size:18px; border-top: 1px solid #676767; border-right: 1px solid #676767; border-left: 1px solid #676767; background-color:#fff; "><?php echo 'Lista de Precios ST. HONORE- Área Comercial / Comité Ejecutivo';?></th>
                </tr>
              </thead>
              <thead>
              	<tr>
                	<th colspan="13" align="left" style="color:#1f497d;font-size:14px; border-right: 1px solid #676767; border-left: 1px solid #676767; background-color:#fff;"><?php echo 'Vigencia '.date("Y"); ?></th>
                </tr>
              </thead>
              <thead>
              	<tr>
                	<th colspan="13" align="left" style="color:#1f497d;font-size:12px; border-bottom:1px solid #676767; border-right: 1px solid #676767; border-left: 1px solid #FFF; background-color:#fff;"><?php echo 'Marca : ' .$fmarca.' - Brand Manager: '.$vendedorSelect; ?></th>
                </tr>
              </thead>
			 <thead>
					<tr>
            ...
            <thead>
				<tr style="color:#1f497d;">
                    <th style="border-top: 1px solid #676767; background-color:#d9d9d9;">LINEA</th>
					<th style="border-top: 1px solid #676767;background-color:#d9d9d9;">REFERENCE</th>
					<th style="border-top: 1px solid #676767;background-color:#d9d9d9;">DESCRIPTION</th>
					<th style="border-top: 1px solid #676767;background-color:#d9d9d9;">SKU / EAN</th>
					<th style="border-top: 1px solid #676767;background-color:#d9d9d9;">Tamaño ml</th>
					<th style="border-top: 1px solid #676767;background-color:#d9d9d9;">Segmento</th>
					<th style="border-top: 1px solid #676767;background-color:#d9d9d9;">Género</th>
					<th style="border-top: 1px solid #676767;background-color:#d9d9d9;">Estatus</th>
					<th style="border-top: 1px solid #676767;background-color:#d9d9d9;">Unidades por caja</th>
					<th style="border-top: 1px solid #676767;background-color:#d9d9d9;">Precio Compra USD</th>
					<th style="border-top: 1px solid #676767;background-color:#d9d9d9;">Precio DFS USD</th>
					<th style="border-top: 1px solid #676767;background-color:#d9d9d9;">Precio Venta CLP Zofri</th>
					<th style="border-top: 1px solid #676767;background-color:#d9d9d9;">Precio Venta CLP Aero</th>
				</tr>
			</head>
                <tbody>
                 <?php
		...
		if($consultar){
			...
			while($resultado = odbc_fetch_array($rs)){
				...
				if($repiteLinea == utf8_safe($resultado['LINEA'])){
					...
					echo '<td style="width:780px;">'.utf8_safe($resultado['DESCRIPTION']).'</td>';
					echo '<td style="text-align:center;">'.utf8_safe($resultado['SKU'])."&nbsp;".'</td>';
					echo '<td style="text-align:center;">'.number_format($resultado['CapVolu'],'0',',','.').'</td>';
					echo '<td style="text-align:center;">'.utf8_safe($resultado['Segmento']).'</td>';
					echo '<td style="text-align:center;">'.utf8_safe($resultado['Genero']).'</td>';
					echo '<td style="text-align:center;">'.utf8_safe($resultado['Status']).'</td>';
					...
					echo '<td colspan="13" style="border: 1px solid; text-align:left; font-weight:bold; font-size:16px; background-color:#d9d9d9; color:#FFF;">'.utf8_safe($resultado['LINEA']).'</td>';
					echo '</tr>';
					echo '<tr>';
				
					echo '<td style="border-top: 1px solid #676767;">'.utf8_safe($resultado['Referencia'])."&nbsp;".'</td>';
					echo '<td style="width:780px; border-top: 1px solid #676767;">'.utf8_safe($resultado['DESCRIPTION']).'</td>';
					echo '<td style="border-top: 1px solid #676767; text-align:center;">'.utf8_safe($resultado['SKU'])."&nbsp;".'</td>';
					echo '<td style="border-top: 1px solid #676767; text-align:center;">'.number_format($resultado['CapVolu'],'0',',','.').'</td>';
					echo '<td style="border-top: 1px solid #676767; text-align:center;">'.utf8_safe($resultado['Segmento']).'</td>';
					echo '<td style="border-top: 1px solid #676767; text-align:center;">'.utf8_safe($resultado['Genero']).'</td>';
					echo '<td style="border-top: 1px solid #676767; text-align:center;">'.utf8_safe($resultado['Status']).'</td>';
