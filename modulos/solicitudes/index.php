...
FROM         dbo.sisap_solicitudes LEFT OUTER JOIN
                      dbo.sisap_usuarios ON dbo.sisap_solicitudes.vendedor_id = dbo.sisap_usuarios.usuario_id WHERE  ".$_SESSION["usuario_modulo"]." LIKE  dbo.sisap_solicitudes.modulo and (fecha_estado>'2024-07-01'or fecha_estado is null)
