...
/*$sql2="SELECT SUM ([TotalCLP]) AS TotalCLP
      ...
      ,[SlpCode]
	  ".$nameMarca."
 FROM [RP_REGGEN].[dbo].[SI_VentasPorVendedorUnion_Air_ON]
...
SELECT
  ...
  AND Empresa NOT IN ('EXB_ZOFRI','SVX_ZOFRI')  ".$conModulo." ".$conMarca."
  ".$WtipoProducto."
        ...
        <div id="one"> <form action="" method="GET" id="horizontalForm">
            <fieldset>
				<legend>Ingresar Fechas</legend>
							 ...
							 <input name="opc" type="hidden" id="opc" size="40" class="required" value="topvendedoresAir" />
...
<div id="usual1" class="usual" > 
  <ul> 
    <li ><a id="tabdua" href="#tab1" class="selected">Gráfico Top Vendedores Aeropuerto</a></li> 
					...
					//echo $sql;	
							...
							exit( "Error en la consulta SQL" );
							 ...
							 while($resultado2 = odbc_fetch_array($rs2)){ 
									...
									$Pi1[] = (($resultado2["TotalCLP"]/$total2)*100);
