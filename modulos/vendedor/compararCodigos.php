...
WHERE     (dbo.RP_Articulos.ALU ='".$codbarra."') ";
		...
		echo'	<div id="muestraPrecio" class="caja" style="margin-top:10px;overflow:auto;">
					<div id="muestraPrecio" class="caja2" style="margin-top:10px; font-size:24px; text-align:center; padding-top:20px;background-color: #9BD7D5;">
						...
						<div id="muestraPrecio" class="caja2" style="margin-top:10px; font-size:24px; text-align:center; padding-top:10px;float:left;width:15%; height:10px; background-color: #054950;border: 1px solid #d5d5d5;">
								<span>13-1</span>	
						...
						<div id="muestraPrecio" class="caja2" style="margin-top:10px; font-size:24px; text-align:center; padding-top:10px;float:left;width:16%;height:10px;  background-color: #054950;border: 1px solid #d5d5d5;">
								<span>1623 </span>	
						</div>
						
						<!-- modulos -->
										
						<div id="muestraPrecio" class="caja2" style="margin-top:1px; font-size:24px; text-align:center; padding-top:10px;float:left;width:15%; height:80px; background-color: #054950;border: 1px solid #d5d5d5;">
						...
						<div id="muestraPrecio" class="caja2" style="margin-top:1px; font-size:24px; text-align:center; padding-top:10px;float:left;width:16%;height:80px;  background-color: #054950;border: 1px solid #d5d5d5;">
...
SELECT TOP 1000 [ItemCode]
  ...
  WHERE ItemCode = '".$codbarra."' AND(WhsCode NOT IN ('ZFI.1010', 'ZFI.181', 'ZFI.184', 'ZFI.2002', 'ZFI.1132', 'ZFI.6130', 'ZFI.33', 'ZFI.66', 'NA', 'ZFI.6115')) ";
