...
$sql="SELECT 
	  ...
	  ,[CifTotal]
	  ,[Cantidad]
  FROM [RP_REGGEN].[dbo].[SI_LotesDisponibles_ON]
        ...
        <div id="one"> <form action="" method="GET" id="horizontalForm">
            <fieldset>
				<legend>Ingresar Filtros</legend>
							 ...
							 <input name="opc" type="hidden" id="opc" size="40" class="required" value="stockMarcaAir" />
							...
							<?php
							 	if($_SESSION["usuario_modulo"] == -1)
								{
									...
									<option value="001">Local 2 y 3</option>
...
<div id="usual1" class="usual" > 
  <ul> 
    ...
    <li ><a id="tabdua" href="#tab3" class="selected">Detalle</a></li> 
  </ul> 
              ...
              <thead>
					...
					$cantotal =0;
							...
							while($resultado = odbc_fetch_array($rs)){ 
							   ...
							   echo '<tr>
									...
									<td >'.utf8_encode(getmoduloAir($resultado["Bodega"])).'</td>
                ...
                <tfoot>
                	<tr  style=" border-top:2px double #B5B5B5;">
                        ...
                        <td><strong><?php echo number_format($totalCifTotal, 2, ',', '.'); ?></strong></td>
