                ...
                <tbody>
                 <?php
					...
					$cantotalnotacredito =0;
                      ...
                      RP_REGGEN.dbo.RP_ReceiptsDet_SAP.Cantidad, RP_REGGEN.dbo.oITM_From_SBO.ItemName, RP_REGGEN.dbo.oITM_From_SBO.U_VK_Marca, RP_REGGEN.dbo.RP_ReceiptsDet_SAP.Vendedor, RP_REGGEN.dbo.View_OMAR.Name, 
                      RP_REGGEN.dbo.RP_ReceiptsDet_SAP.TipoDocto, RP_REGGEN.dbo.RP_ReceiptsCab_SAP.NumeroDoctoRef, RP_REGGEN.dbo.RP_ReceiptsCab_SAP.Workstation
...
WHERE       (RP_REGGEN.dbo.RP_ReceiptsCab_SAP.FechaDocto >= '".$finicio2." 00:00:00.000') AND (RP_REGGEN.dbo.RP_ReceiptsCab_SAP.FechaDocto <= '".$ffin2." 23:59:59.000') ".$Wmodulo." ".$Wvendedor." ".$Wmarca." ".$Wcodbarra." ORDER BY RP_REGGEN.dbo.RP_ReceiptsCab_SAP.FechaDocto" ;
