...
$sql="SELECT  
  ...
  GROUP BY [WhsCode],ItemCode,ItemName,Name,Code 
        ...
        <div id="one"> <form action="" method="GET" id="horizontalForm">
            <fieldset>
				<legend>Ingresar Filtros</legend>
							 ...
							 <input name="opc" type="hidden" id="opc" size="40" class="required" value="stockMarcaBodega" />
						...
						{	
							...
							while($resultado = odbc_fetch_array($rs)){ 
							   ...
							   echo '<tr>
									...
									<td ><strong>'.(int)promedioVenta($resultado["ItemCode"]).'</strong></td>
