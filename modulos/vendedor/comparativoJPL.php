...
(SELECT 
 ...
 FROM [SAPSQL.DHN.CL].[SBO_Imp_Eximben_SAC].[dbo].[VIC_VW_VtasD_RPRO_Slim] 
                            ...
                            while($resultado = odbc_fetch_array($rs0))
							 { 
								  ...
								  echo '<tr>
										...
										<td  >'.utf8_safe(str_replace("ZFI.","LOCAL ",$resultado["WhsCode2"])).'</td> 
                            ...
                            while($resultado2 = odbc_fetch_array($rs2))
							 { 
								  ...
								  echo '<tr>
										...
										<td  >'.utf8_safe(str_replace("ZFI.","LOCAL ",$resultado2["WhsCode2"])).'</td> 
                            ...
                            while($resultado3 = odbc_fetch_array($rs3))
							 { 
								  ...
								  echo '<tr>
										...
										<td  >'.utf8_safe(str_replace("LOCAL.","LOCAL ",$resultado3["WhsCode2"])).'</td> 
...
SELECT 
  ...
  FROM [SAPSQL.DHN.CL].[SBO_Imp_Eximben_SAC].[dbo].[VIC_VW_Vtas_Mayor_CIF]
