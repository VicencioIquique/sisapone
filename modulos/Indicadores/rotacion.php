...
<link rel="stylesheet" type="text/css" href="../../temas/minimalplomo/minimalplomo.css"><!-- estilos geneales-->';//incluyo la librería para generar graficos	
	include("../../graficos/rotacion.php");// grafico 
?>
...
<div id="usual1" class="usual" > 
  <ul> 
    ...
    <li ><a id="tabdua" href="#tab2" class="selected" >Seguimiento de Stock</a></li> 
 </ul> 
 </div>
  <div id="tab1">
  ...
  <div id="tab2">
		...
		<div id="rotacion" style="width:100%; height: 400px;"></div>
  </div> <!-- fin de grafico de marcas -->
